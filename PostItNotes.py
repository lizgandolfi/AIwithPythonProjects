...
title_label = Label(window, text="Your Notes").pack()
#Read inputs
#Date input
...
notes_entry = Text(window, width=50,height=8)
notes_entry.place(x=60,y=90)

#Perform notes functions
button1 = Button(window,text='Add Notes', bg = 'Light Blue',fg='Black',command=add_notes).place(x=60,y=240)
button2 = Button(window,text='View Notes', bg = 'Light Blue',fg='Black',command=view_notes).place(x=160,y=240)
button3 = Button(window,text='Delete Notes', bg = 'Light Blue',fg='Black',command=delete_notes).place(x=270,y=240)
button4 = Button(window,text='Update Notes', bg = 'Light Blue',fg='Black',command=update_notes).place(x=380,y=240)
